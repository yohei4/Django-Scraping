/** JWTトークン */
/** ログイン */
export const LOGIN: string = '/api/token/';
/** ログイン */
export const LOGOUT: string = '/api/logout/';
/** アカウント登録 */
export const REGISTER: string = '/api/account/register/';
...
/** 画像一覧取得 */
export const FETCH_USER_IMAGE: string = '/api/album/user-images/';
/** 画像保存処理 */
export const SAVE_IMAGE: string = '/api/album/save-image/';